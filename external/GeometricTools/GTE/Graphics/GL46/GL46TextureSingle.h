...
namespace gte
{
    class GL46TextureSingle : public GL46Texture
    {
    public:
        // Abstract base class, a shim to distinguish between single textures
        // and texture arrays.
        virtual ~GL46TextureSingle();
    protected:
        // No public construction.  Derived classes use this constructor.
        GL46TextureSingle(TextureSingle const* gtTexture, GLenum target, GLenum targetBinding);
    ...
    public:
        ...
        void CopyLevelGpuToGpu(GL46TextureSingle* texture, uint32_t level)
        {
            (void)texture;
            (void)level;
