...
bool DistanceRectangleBoxWindow3::OnCharPress(uint8_t key, int32_t x, int32_t y)
{
...
void DistanceRectangleBoxWindow3::Translate(int32_t direction, float delta)
{
...
void DistanceRectangleBoxWindow3::Rotate(int32_t direction, float delta)
{
