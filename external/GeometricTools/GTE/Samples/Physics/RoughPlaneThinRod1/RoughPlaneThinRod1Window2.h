...
// This is an implementation of an algorithm in Section 4 of
// https://www.geometrictools.com/Documentation/RoughPlaneAnalysis.pdf

class RoughPlaneThinRod1Window2 : public Window2
{
public:
    RoughPlaneThinRod1Window2(Parameters& parameters);
