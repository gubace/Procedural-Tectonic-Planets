...
// This is an implementation of an algorithm in Section 5 of
// https://www.geometrictools.com/Documentation/RoughPlaneAnalysis.pdf

class RoughPlaneFlatBoardWindow2 : public Window2
{
public:
    RoughPlaneFlatBoardWindow2(Parameters& parameters);
