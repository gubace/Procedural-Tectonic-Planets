...
inline const char* OrogenyTypeToString(OrogenyType t) {
    switch (t) {
        case OrogenyType::Collisional:
            return "collisional";
        case OrogenyType::Subduction:
            return "subduction";
        case OrogenyType::Rifting:
            return "rifting";
        case OrogenyType::NoneType:
            return "none";
    }
    return "unknown";
}
   ...
   public:
    ...
    ContinentalCrust(float thick, float elev, float orogeny_age_,
        ...
        : Crust(CrustType::Continental, thick, elev),
          orogeny_age(orogeny_age_),
          orogeny_type(orogeny_type_),
          fold_dir(fold) {}
